...
const {User , Game, Doc, Donation, Doc} = sequelize.models;
...
User.belongsToMany(Doc, {through: "UserGame"}, {timeStamps: false})
Doc.belongsToMany(User, {through: "UserGame"}, {timeStamps: false})
